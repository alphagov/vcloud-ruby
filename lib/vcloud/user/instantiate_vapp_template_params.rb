module VCloud
  ...
  class InstantiateVAppTemplateParams
    ...
    # @param [Boolean] deploy True if the vApp should be deployed at
    #   instantiation. Defaults to true.
    # @param [Boolean] power_on True if the vApp should be powered-on at
    #   instantiation. Defaults to true.
    # @param [String] description Description of the vApp
    # @param [Boolean] all_eulas_accepted True confirms acceptance of all EULAs
    #   in a vApp template. Instantiation fails if this element is missing,
    #   empty, or set to false and one or more EulaSection elements are
    #   present.
    # @param [Boolean] is_source_delete Set to true to delete the source object
