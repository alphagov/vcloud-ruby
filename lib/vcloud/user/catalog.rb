module VCloud
  ...
  class Catalog < BaseVCloudEntity
    ...
    #   name.
    # @return [Hash{String => VCloud::Reference}] Reference to all
    #   CatalogsItems in the Catalog, keyed by name.
    ...
    # @param [VCloud::Client] session Session to use to retrieve the
    #   CatalogItem.
